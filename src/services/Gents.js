...
import MenBanner from "../images/Gents-services/1.png";
import GentsHairServices from "../images/Gents-services/gents_icon-1.png";
import GentsSkinServices from "../images/Gents-services/gents_icon-2.png";
import "../App.css";
...
const Gents = () => {
  ...
  return (
    <div>
      ...
      <GenderNav />
      <div>
        <img src={MenBanner} alt="men banner" className="" />
      </div>
      <br />
      <div style={{ display: "flex", gap: "1.4em" }}>
        ...
        <div className="servicesCards">
          ...
          <ul className="checkbox-list">
            {getServicesByCategory("gents", "Haircut & Finish").map(
              (service) => (
                <li
                  key={service._id}
        ...
        <div className="servicesCards">
          ...
          <ul className="checkbox-list">
            {getServicesByCategory("gents", "Hair Texture").map((service) => (
              <li
                key={service._id}
                style={{ display: "flex", justifyContent: "space-between" }}
              >
        ...
        <div className="servicesCards">
          ...
          <ul className="checkbox-list">
            {getServicesByCategory("gents", "Hair Treatments").map(
              (service) => (
                <li
                  key={service._id}
                  style={{ display: "flex", justifyContent: "space-between" }}
      ...
      <div style={{ display: "flex", gap: "1.4em" }}>
        ...
        <div className="servicesCards">
          ...
          <ul className="checkbox-list">
            {getServicesByCategory("gents", "Beard Grooming").map((service) => (
              <li
                key={service._id}
                style={{ display: "flex", justifyContent: "space-between" }}
              >
        ...
        <div className="servicesCards">
          ...
          <ul className="checkbox-list">
            {getServicesByCategory("gents", "Hand & Feet").map((service) => (
              <li
                key={service._id}
                style={{ display: "flex", justifyContent: "space-between" }}
              >
        ...
        <div className="servicesCards">
          ...
          <ul className="checkbox-list">
            {getServicesByCategory("gents", "Nail Care").map((service) => (
              <li
                key={service._id}
                style={{ display: "flex", justifyContent: "space-between" }}
              >
